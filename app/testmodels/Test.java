...
public class Test {
	...
	public static User getUser(){
		...
		shippingAddresses[0] = new Address("Puerto Rico", "Kevin Castillo", "Calle Plantio # 48 Urb. Paseos del Prado", "Carolina", "PR", 
				"00987", "787-757-5115");
		shippingAddresses[1] = new Address("Puerto Rico", "Kevin Castillo", "Calle El Sole # 30 Urb. Terrace", "Mayaguez", "PR", 
				"00777", "787-777-7777");
		CreditCard[] creditCards = new CreditCard[1];
		creditCards[0] = new CreditCard("1111111111", "Samuel Castillo", "09/09/14");
